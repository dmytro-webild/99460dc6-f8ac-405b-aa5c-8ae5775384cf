...
export default function LandingPage() {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "1",          title: "Absolutely outstanding service!",          quote: "Junior Mobile Detailing brought my car back to life. The attention to detail was incredible, and the convenience of them coming to my office was a game-changer. Highly recommend!",          name: "Sarah J.",          role: "Marketing Executive",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3EgzsipZwd3Gn5A6GsVUFBvEYFA/tmp/clean-car-1780621258906-cc3c9bfe.png",          imageAlt: "Smiling woman in business attire"},
        {
          id: "2",          title: "My car has never looked this good!",          quote: "I'm always impressed by the professionalism and thoroughness. Every nook and cranny is spotless, and the exterior shine lasts for weeks. Worth every penny!",          name: "Michael D.",          role: "Small Business Owner",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3EgzsipZwd3Gn5A6GsVUFBvEYFA/tmp/clean-car-1780621322353-48e3a644.png",          imageAlt: "Smiling man in casual wear"},
        {
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        ...
        {
          id: "faq-3",          title: "Do I need to provide water or electricity?",          content: "yes"},
        {
  ...
  <div id="footer" data-section="footer">
      ...
      copyrightText="© 2026 Junior Mobile Detailing. All rights reserved."
      socialLinks={[
        {
          icon: Facebook,
